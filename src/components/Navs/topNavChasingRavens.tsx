...
interface TopNavChasingRavensProps {
  themes: string[];
...
const TopNavChasingRavens: React.FC<TopNavChasingRavensProps> = ({ themes, activeTheme, onThemeSwitch, onMouseEnter, onMouseLeave }) => {
  ...
  const navLinks = ['project brief', 'design process', 'results']
...
export default TopNavChasingRavens;
