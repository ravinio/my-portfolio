...
interface TopNavSistermaeProps {
  themes: string[];
...
const TopNavSistermae: React.FC<TopNavSistermaeProps> = ({ themes, activeTheme, onThemeSwitch, onMouseEnter, onMouseLeave }) => {
  ...
  const navLinks = ['project brief', 'research', 'design process', 'results']
...
export default TopNavSistermae;
