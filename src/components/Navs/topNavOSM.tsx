...
const TopNavOSM: React.FC<TopNavOSMProps> = ({ themes, activeTheme, onThemeSwitch, onMouseEnter, onMouseLeave }) => {
  ...
  const navLinks = ['project brief', 'main challenge', 'user research', 'design process', 'results']
